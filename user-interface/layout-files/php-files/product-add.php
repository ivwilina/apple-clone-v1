...
<body>
    ...
    // $spec_info_json = json_encode($spec_info_array,JSON_UNESCAPED_UNICODE);
    // $spec_choice_json = json_encode($spec_choice_array,JSON_UNESCAPED_UNICODE);
    // $spec_color_json = json_encode($spec_color_array,JSON_UNESCAPED_UNICODE);
    // $spec_source_json = json_encode($spec_source_array,JSON_UNESCAPED_UNICODE);
    
    // $json_data_array['information'] = $spec_info_json;
    // $json_data_array['choice'] = $spec_choice_json;
    // $json_data_array['color'] = $spec_color_json;
    // $json_data_array['imagesource'] = $spec_source_json;
