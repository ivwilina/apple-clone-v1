...
<head>
    ...
    <link rel="stylesheet" href="/baitaplon-final/user-interface/css-files/user-bill.css">
...
<body>
    ...
    <script src="/baitaplon-final/user-interface/function-files/user-bill.js"></script>
</body>
