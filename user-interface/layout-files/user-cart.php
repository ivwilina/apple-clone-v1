...
<head>
    ...
    <link rel="stylesheet" href="/baitaplon-final/user-interface/css-files/user-cart.css">
...
<body>
                ...
                <div class="cart-content">
                    ...
                    foreach ($cartitem as $item) {
                        ...
                        ?>
                            ...
                            <div class="option-choice">
                                ...
                                <img src="/baitaplon-final/img-files/icons/remove.png" alt="" onclick="removeCart('<?php echo $item['BagId']?>')">
                            </div>
                        </div>
                        <?php
                    }
                    ...
                    <div class="checkout-container">
                        ...
                        <div class="customer-info">
                            <p>Tên khách hàng</p>
                            <input type="text" name="fullname" id="userName" required="" value="<?php echo $userdata['Name']?>">
                            <p>Số điện thoại</p>
                            <input type="tel" name="phonenumber" id="userTel" placeholder="0123456789"
                                pattern="[0-9]{4}[0-9]{3}[0-9]{3}" required="" value="<?php echo $userdata['PhoneNumber']?>">
                            <p>Địa chỉ</p>
                            <input type="text" name="address" id="userAddress" required="" value="<?php echo $userdata['Address']?>">
                        </div>
                        <div class="price">
    ...
    <script src="/baitaplon-final/user-interface/function-files/user-cart.js"></script>
