...
<head>
    ...
    <link rel="stylesheet" href="/baitaplon-final/user-interface/css-files/user-info.css">
    ...
    <section>
        <div class="section-wrapper">
            <div class="section-container">
                <form action="/baitaplon-final/user-interface/layout-files/php-files/user-update.php" method="post">
